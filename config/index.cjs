...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: 'trXRjF357Khqb2UN8tqlTyHTD-XRH0xiIutvLN8xRXc',
      ...
      festivals: [
        ...
        {
          type: '节日', name: '77爱小胖', year: '2022', date: '01-22',
        },
      ],
      // 我们在一起已经有xxxx天了的配置
      customizedDateList: [
  ...
  CALLBACK_TEMPLATE_ID: 'trXRjF357Khqb2UN8tqlTyHTD-XRH0xiIutvLN8xRXc',
